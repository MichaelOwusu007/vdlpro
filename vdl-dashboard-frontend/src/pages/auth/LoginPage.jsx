      ...
      <div className="flex w-full md:w-1/2 items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="font-sans my-4">
            Sign in to access your dashboard and manage orders, inventory and more.
          </p>

          <div className="relative inline-block mb-8">
            <h2 className="text-2xl font-bold">Sign In</h2>
            <svg className="absolute left-0 -bottom-3 w-full h-4 text-green-500" viewBox="0 0 100 10" fill="none" xmlns="http://www.w3.org/2000/svg">
